...
export const CURRENCY_INFO: Record<Currency, CurrencyInfo> = {
  ...
  MYR: { symbol: "RM", locale: "en-MY", defaultMessageRateMinor: 13, gateway: "stripe" },
...
export const COUNTRY_PRESETS = [
  ...
  { code: "MY", label: "Malaysia", dialCode: "+60", currency: "MYR" as Currency, timezone: "Asia/Kuala_Lumpur" },
