...
export const envSchema = z
  ...
  .superRefine((vars, ctx) => {
    if (vars.SEND_MODE === "live") {
      // Client apps and number credentials are encrypted per workspace.
      // Global webhook secrets remain optional for unmigrated legacy clients.
      const requiredLive = ["TOKEN_ENCRYPTION_KEY"] as const;
